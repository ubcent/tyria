      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="text-center">
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
            <span className="text-primary-600">Proxy-as-a-Service</span>
            <br />
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div>
            <div className="text-3xl font-bold text-primary-600">&lt;10ms</div>
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
            ...
            <div className="flex items-center justify-center space-x-8 text-center">
              <div className="flex flex-col items-center">
                ...
                <div className="text-sm font-medium text-gray-900">Client App</div>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-sm font-medium text-gray-900">Edge.link</div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="text-sm font-medium text-gray-900">Your APIs</div>
              </div>
            </div>
          </div>
        </div>
