    ...
    <section className="py-20 bg-gradient-to-r from-primary-600 to-blue-600 dark:from-primary-700 dark:to-blue-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <Link 
            href="/dashboard" 
            className="bg-white text-primary-600 hover:bg-gray-50 dark:bg-gray-100 dark:text-primary-600 dark:hover:bg-gray-200 px-8 py-3 rounded-md font-medium text-lg inline-flex items-center justify-center transition-colors"
          >
            Start Free Trial
          ...
          <a 
            href="#contact" 
            className="border-2 border-white text-white hover:bg-white hover:text-primary-600 dark:hover:bg-gray-100 dark:hover:text-primary-600 px-8 py-3 rounded-md font-medium text-lg inline-flex items-center justify-center transition-colors"
          >
            Talk to Sales
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-80">
          <div className="text-white text-center">
            ...
            <div className="text-sm text-blue-100 dark:text-blue-200">Uptime SLA</div>
          </div>
          <div className="text-white text-center">
            <div className="text-2xl font-bold">10M+</div>
            <div className="text-sm text-blue-100 dark:text-blue-200">Requests Served</div>
          </div>
          <div className="text-white text-center">
